        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-y-3">
                <div>
                    ...
                    <p class="text-base">
                        {{ $record->start_date ? $record->start_date->format('M d, Y H:i') : 'Date not set' }}</p>
                </div>

                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Instructor</p>
                    <p class="text-base">{{ $record->instructor->name ?? 'No instructor assigned' }}</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ $record->att_student ? 'Signed' : 'Not signed' }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ $record->att_instructor ? 'Signed' : 'Not signed' }}</p>
                </div>
            </div>
        </div>
    </div>
